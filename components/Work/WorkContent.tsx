    ...
    <WorkContainer>
      <WorkLeft progress={progress}>
        <div className="text-center mx-2">
          <div className="text-2xl font-bold md:text-5xl xl:text-6xl">{title}</div>
          <p className="prose max-w-none mx-auto pb-8 dark:prose-dark text-lg tracking-tight md:text-2xl xl:text-3xl flex flex-wrap">
            {description}
          </p>
        </div>{' '}
      </WorkLeft>
