...
package name to whatever we want, in our case it is called `@geniuskingsley/playground`

```json:package.json
"name": "@geniuskingsley/playground",
"author": "Chidera Kingsley",
"version": "0.0.1",
```
...
Boom, you are done! you can now check our NPM account for our new package i.e [@geniuskingsley/playground]().
