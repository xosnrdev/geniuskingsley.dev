...
In this guide, I'll be creating my component library `selector`, this is where (I'm hoping) I can show off some of the cool component ideas I have to the world and
...
![create-selector](/static/blog/create-playground.webp)
...
package name to whatever we want, in our case it is called `@geniuskingsley/selector`

```json:package.json
"name": "@geniuskingsley/selector",
"author": "Chidera Kingsley",
"version": "0.0.1",
```
...
Boom, you are done! you can now check our NPM account for our new package i.e [@geniuskingsley/selector]().
...
makes it simple to bootstrap your very own component library.
